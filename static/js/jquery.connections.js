// This is an amended version of jquery-connections
// https://github.com/musclesoft/jquery-connections
//
// MIT Licence
// See: https://github.com/musclesoft/jquery-connections/blob/gh-pages/LICENSE.txt
//
// This version has been amended rather hackily to add arrowheads to the
// connections
...
(function($) {
  ...
  var createConnection = function(
    ...
    var arrowhead = $("<arrowhead/>", options).css(css)
    arrowhead.appendTo(container);
    $.data(connection.get(0), "arrowhead", arrowhead.get(0));
  ...
  var update = function(connection) {
    ...
    arrowhead = $.data(connection, "arrowhead");
    ...
    if (direction == "left") {
      arrowheadcss.left = data.css.left - (arrowsize) + 4;
      arrowheadcss.top = data.css.top + data.css.height - (arrowsize) - (border_h / 2);
      arrowheadcss.transform = "rotate(225deg)"
    } else if (direction == "right") {
      arrowheadcss.left = data.css.left + data.css.width - (arrowsize) - 4;
      arrowheadcss.top = data.css.top - arrowsize + (border_h / 2);
      arrowheadcss.transform = "rotate(45deg)"
    } else if (direction == "up") {
      arrowheadcss.left = data.css.left + data.css.width + (arrowsize / 2);
      arrowheadcss.top = data.css.top + 4;
      arrowheadcss.transform = "rotate(315deg)"
    } else if (direction == "down") {
      arrowheadcss.left = data.css.left + data.css.width + (border_w);
      arrowheadcss.top = data.css.top + data.css.height - (arrowsize) - 4;
      arrowheadcss.transform = "rotate(135deg)"
    }
